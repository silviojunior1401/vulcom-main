...
// O cliente pode ter, no máximo, 120 anos
...
const Customer = z.object({
    name: z
        ...
        .includes(" ", {
            message:
                "O nome deve ter um espaço em branco separando prenome e sobrenome",
        }),
    ...
    complements: z
        ...
        .trim()
        .max(20, {
            message: "Complemento deve ter, no máximo, 20 caracteres.",
        })
        .nullish(),
    ...
    phone: z
        ...
        .refine((val) => val.length === 15, {
            message:
                "O número do telefone/celular deve ter exatas 15 posições.",
        }),
